...
// Source: github.com/paullesiak/ladon (interfaces: Manager)
...
func (m *MockManager) Create(arg0 ladon.Policy) error {
	m.ctrl.T.Helper()
...
func (m *MockManager) FindPoliciesForResource(arg0 string) (ladon.Policies, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindPoliciesForResource", arg0)
...
func (mr *MockManagerMockRecorder) FindPoliciesForResource(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindPoliciesForResource", reflect.TypeOf((*MockManager)(nil).FindPoliciesForResource), arg0)
}

// FindPoliciesForSubject mocks base method.
func (m *MockManager) FindPoliciesForSubject(arg0 string) (ladon.Policies, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindPoliciesForSubject", arg0)
	ret0, _ := ret[0].(ladon.Policies)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockManagerMockRecorder) FindPoliciesForSubject(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindPoliciesForSubject", reflect.TypeOf((*MockManager)(nil).FindPoliciesForSubject), arg0)
}

// FindRequestCandidates mocks base method.
func (m *MockManager) FindRequestCandidates(arg0 *ladon.Request) (ladon.Policies, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindRequestCandidates", arg0)
	ret0, _ := ret[0].(ladon.Policies)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockManagerMockRecorder) FindRequestCandidates(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindRequestCandidates", reflect.TypeOf((*MockManager)(nil).FindRequestCandidates), arg0)
}

// Get mocks base method.
func (m *MockManager) Get(arg0 string) (ladon.Policy, error) {
	m.ctrl.T.Helper()
...
func (m *MockManager) GetAll(arg0, arg1 int64) (ladon.Policies, error) {
	m.ctrl.T.Helper()
...
func (m *MockManager) Update(arg0 ladon.Policy) error {
	m.ctrl.T.Helper()
